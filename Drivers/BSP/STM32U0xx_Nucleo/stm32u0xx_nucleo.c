/**
  ******************************************************************************
  * @file    stm32u0xx_nucleo.c
  * @author  MCD Application Team
  * @brief   This file provides set of firmware functions to manage:
  *          - LEDs and push-button available on STM32U0xx-Nucleo Kit
...
/** @addtogroup STM32U0XX_NUCLEO_LOW_LEVEL
  * @brief This file provides set of firmware functions to manage Leds and push-button
  *        available on STM32U0xx-Nucleo Kit from STMicroelectronics.
  * @{
  */

/** @defgroup STM32U0XX_NUCLEO_LOW_LEVEL_Private_Defines LOW LEVEL Private Defines
  * @{
  */
...
/** @defgroup STM32U0XX_NUCLEO_LOW_LEVEL_Private_TypesDefinitions LOW LEVEL Private Typedef
  * @{
  */
...
/** @defgroup STM32U0XX_NUCLEO_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Variables
  * @{
  */
...
/**
  * @}
  */
/** @defgroup STM32U0XX_NUCLEO_LOW_LEVEL_Private_Variables LOW LEVEL Private Variables
  * @{
  */
...
/** @defgroup STM32U0XX_NUCLEO_LOW_LEVEL_Private_FunctionPrototypes LOW LEVEL Private functions Prototypes
  * @{
  */
...
/** @defgroup STM32U0XX_NUCLEO_LOW_LEVEL_Exported_Functions LOW LEVEL Exported Functions
  * @{
  */

/**
  * @brief  This method returns the STM32U0XX NUCLEO BSP Driver revision
  * @retval version: 0xXYZR (8bits for each decimal, R for RC)
  */
int32_t BSP_GetVersion(void)
{
  return (int32_t)STM32U0XX_NUCLEO_BSP_VERSION;
}
...
{
  return (uint8_t *)STM32U0XX_NUCLEO_BSP_BOARD_NAME;
}
...
{
  return (uint8_t *)STM32U0XX_NUCLEO_BSP_BOARD_ID;
}
...
/** @defgroup STM32U0XX_NUCLEO_LOW_LEVEL_Private_Functions LOW LEVEL Private functions
  * @{
  */
/**
